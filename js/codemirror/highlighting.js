...
CodeMirror.defineMode("asm", function() {
    const instructions = /^(READFL|READS|READI|READC|FSTP|FADD|FSUB|FMUL|FDIV|FLD|PRINTFL|PRINTC|PRINTS|PRINTI|MOV|ADD|SUB|MUL|DIV|INC|DEC|NEG|AND|OR|XOR|NOT|SHL|SHR|CMP|TEST|JMP|JE|JNE|JG|JL|JGE|JLE|JZ|JNZ|JC|JNC|JS|JNS|CALL|RET|PUSH|POP|NOP|HLT|INT|LEA|XCHG|CBW|CWD|PRINT|PRINTLN|LOOP)\b/i;
